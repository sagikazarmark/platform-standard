...
/**
 * This command is a temporary workaround to solve the following issue:
 *
 * @see https://github.com/doctrine/DoctrineBundle/issues/384
 *
...
class CreateDatabaseDoctrineCommand extends DoctrineCommand
{
    ...
    {
        $this
            ->setName('hotfix:doctrine:database:create')
            ->setDescription('Temporary command override until doctrine bundle is updated (--if-not-exists is buggy in older releases)')
